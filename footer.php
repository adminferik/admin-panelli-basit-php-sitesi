	<footer class="short" id="footer">
					...
					<div class="row">
						...
						<div class="col-md-3 col-md-offset-1">
							...
							<ul class="list list-icons mt-xl">
								<li><i class="fa fa-map-marker"></i> <strong>Address:</strong> <?php echo $ayarcek['ayar_adres']; ?> / <?php echo $ayarcek['ayar_ilce']; ?></li>
								<li><i class="fa fa-envelope"></i> <strong>Mail:</strong> <a href="mailto:mail@example.com"><?php echo $ayarcek['ayar_mail']; ?></a></li>
							</ul>
						</div>
						<div class="col-md-3">
							<h5 class="mb-sm">İletişim Bilgilerimiz</h5>
				...
				<div class="footer-copyright">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<p>© Copyright 2018. All Rights Reserved. | <a href="http://www.adminferik.com"><?php echo $ayarcek['ayar_author']; ?></a></p>
							</div>
						</div>
					</div>
				</div>
